...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#070a08]/90 backdrop-blur-xl border-t border-white/10 text-gray-400 py-16 px-5 sm:px-8 lg:px-12 relative overflow-hidden" role="contentinfo">
